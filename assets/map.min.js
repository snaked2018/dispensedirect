  ...
  class GoogleMap extends HTMLElement {
    ...
    renderMarker(i, location, map, rendered) {
      ...
      pinimageLoad.addEventListener('load', function () {
        that.setMarkers(i, latlng, marker, marker_size, retina, rendered, title, desc);
      });
    }
    setMarkers(i, latlng, marker, marker_size, retina, rendered, title, desc) {
      let _this = this,
        map = this.map;
      ...
      // info windows
      let contentString = '<h3>' + title + '</h3>' + '<div>' + desc + '</div>',
