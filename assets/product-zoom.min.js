 ...
 */
if (!customElements.get('product-zoom')) {
  customElements.define('product-zoom', class ProductZoom extends HTMLElement {
    constructor() {
      super();
    }
    connectedCallback() {
      this.options = {
        ...
        img: this.dataset.full,
      };
      this.setup();
    }
    setup() {
      this.zoom = new ImageZoom(this, this.options);
    }
    static runZoom() {
      this.setup();
    }
